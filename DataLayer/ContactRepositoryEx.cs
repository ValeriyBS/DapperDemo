...
namespace DataLayer
{
    public class ContactRepositoryEx
    {
        ...
        public async Task<List<Contact>> GetAllContactsWithAddresses()
        {
            ...
            var contacts =  await db.QueryAsync<Contact, Address, Contact>(sql, (contact, address) =>
            {
            ...
            return contactDict.Select(kvp => kvp.Value).ToList();
        }
